      ...
      <main className="flex flex-col lap:items-center justify-center flex-1 lap:p-4 mob:p-2 text-center">
        ...
        <div className="flex flex-col gap-8 mt-10 text-left lap:w-full mob:px-1 px-4">
          ...
          <P>
            ...
            этого. Тут будут статьи, комментарии и, соответственно, возможность регистрации/авторизации. Простой
          ...
          <P>
            ...
            проект развернулся в текущей папке. Далее мне предлагают выбрать использовать  typescript или нет, ESlint
    ...
    <Button onClick={() => theme === "dark" ? setTheme(themes.light) : setTheme(themes.dark)}>
      <div>{themeIcon}</div>
          ...
          <P>
            ...
            шагом сделаю полноценную регистрацию/аутентификацию с JWT, id и access токсинами и cookie.
          </P>
          <div className="overflow-x-auto">
